...
class genrandomimage {
	...
	var $jpeg_quality = 25; // максимальное, можно поставить 70-80
	
	var $keystring = ''; // ключевая генерируемая строка

	// символы, используемые для рисования сгенерированного изображения CAPTCHA	
	var $allowed_symbols = "23456789cuxzknpdsveybewa"; // алфавит БЕЗ похожих символов (o=0, 1=l, i=j, t=f)
	...
	function genimage() {
		...
		$foreground_color = array( mt_rand( 0, 100 ), mt_rand( 0, 100 ), mt_rand( 0, 110 ) );
		$background_color = array( mt_rand( 220, 255 ), mt_rand( 200, 255 ), mt_rand( 190, 255 ) ); // фон всегда светлее

		$fonts = array();
		$fontsdir_absolute = $this->fontsdir; // путь к папке с шрифтами
...
$im->set_fonts(dirname(__FILE__).'/antibot_fonts');
$im->genstring();
