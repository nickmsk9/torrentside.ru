...
//	@header("Refresh: 0; url=403.php");
	...
	if($do == "load")
	{
		...
		$r_op = sql_query("SELECT * FROM polls WHERE forum=$id_topic AND id=".$ar_check["id"],$cache = array("type" => "disk", "file" => "forums_ptop-".$id_topid, "time" => 180))  or sqlerr(__FILE__, __LINE__);
