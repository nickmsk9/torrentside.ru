...
tr('Заменить .torrent', '<input type="file" name="tfile" size="70" accept=".torrent"><br><small>Если загрузите чужой .torrent, можно сохранить внешний swarm ниже.</small>', 1);
tr('Мультитрекер', '<input type="hidden" name="preserve_external_trackers" value="0"><label><input type="checkbox" name="preserve_external_trackers" value="1" checked> Сохранить внешние announce и исходный info_hash при замене файла</label><br><small>Включено по умолчанию, чтобы внешний трекер не отвечал "unregistered torrent".</small>', 1);
