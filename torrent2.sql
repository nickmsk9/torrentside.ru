...
(5, 1, 1, 4, '2025-09-30 11:58:08', '[quote=1]скоро![/quote]\nработает ура', '[quote=1]скоро![/quote]\nработает ура', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(6, 1, 1, 0, '2025-09-30 11:58:22', 'аввафы', 'аввафы', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(7, 1, 1, 0, '2025-09-30 11:58:23', 'вапва', 'вапва', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(8, 1, 1, 0, '2025-09-30 11:58:25', 'апврвпрв', 'апврвпрв', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(9, 1, 1, 0, '2025-09-30 11:58:27', 'аврапр', 'аврапр', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(10, 1, 1, 0, '2025-09-30 11:58:29', 'аправпр', 'аправпр', 0, NULL, '0', '0', '127.0.0.1', 0, 1),
(11, 1, 1, 0, '2025-09-30 11:58:31', 'авпрапр', 'авпрапр', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(13, 1, 1, 7, '2025-09-30 13:40:44', '[quote=admin]вапва[/quote]', '[quote=admin]вапва[/quote]', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(15, 1, 1, 13, '2025-09-30 14:04:47', '[quote=admin][quote=admin]вапва[/quote]\n[/quote]', '[quote=admin][quote=admin]вапва[/quote]\n[/quote]', 0, NULL, '0', '0', '127.0.0.1', 0, 2),
(19, 2, 1, 0, '2025-10-01 12:11:14', 'fgsdfg', 'fgsdfg', 0, NULL, '0', '0', '127.0.0.1', 0, 1),
(20, 2, 1, 19, '2025-10-01 12:21:08', '[quote=1]fgsdfg[/quote]', '[quote=1]fgsdfg[/quote]', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
...
(25, 2, 1, 24, '2025-10-02 15:34:12', '[color=#ffc6c3]каувыаываыв[/color]', '[color=#ffc6c3]каувыаываыв[/color]', 0, NULL, '0', '0', '127.0.0.1', 0, 1),
(26, 12, 1, 0, '2025-10-02 16:15:40', 'gdfgdsfgd', 'gdfgdsfgd', 0, NULL, '0', '0', '127.0.0.1', 0, 0),
(27, 12, 1, 25, '2025-10-02 16:15:49', '[quote=1][color=#ffc6c3]каувыаываыв[/color][/quote]\n да ну?', '[quote=1][color=#ffc6c3]каувыаываыв[/color][/quote]\n да ну?', 0, NULL, '0', '0', '127.0.0.1', 0, 2),
...
CREATE TABLE IF NOT EXISTS `social_accounts` (
  ...
  KEY `idx_social_provider_email` (`provider`,`provider_email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
