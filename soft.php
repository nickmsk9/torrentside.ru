...
<div style="text-align:center">
  ...
  <form id="upload" name="upload" enctype="multipart/form-data" action="takeuploadsoft.php" method="post" accept-charset="UTF-8" autocomplete="off">
    ...
    <table border="1" cellspacing="0" cellpadding="5" style="margin:0 auto;min-width:800px">
      ...
      tr('Мультитрекер', '<input type="hidden" name="preserve_external_trackers" value="0"><label><input type="checkbox" name="preserve_external_trackers" value="1" checked> Сохранить внешние announce и исходный info_hash</label><br><small>Включено по умолчанию для чужих .torrent, если нужен общий swarm.</small>', 1);
